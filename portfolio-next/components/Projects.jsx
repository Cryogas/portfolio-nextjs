...
const Projects = () => {
    return (
        <div id="projects">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-1 gap-x-8 gap-y-6 md:gap-12 lg:grid-cols-2 lg:gap-x-7 xl:grid-cols-2 xl:gap-10 2xl:grid-cols-4 2xl:gap-6">
